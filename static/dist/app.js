...
},{"lazysizes":"../node_modules/lazysizes/lazysizes.js"}],"../node_modules/preact/hooks/dist/hooks.module.js":[function(require,module,exports) {
"use strict";
...
},{"preact":"../node_modules/preact/dist/preact.module.js"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
var api = {
  logInGetToken: function logInGetToken(email, password) {
    var params = new URLSearchParams(); // Using FastAPI OAuth2PasswordRequestForm which requires `username` not email
...
exports.api = api;
},{"axios":"../node_modules/axios/index.js"}],"accounts.js":[function(require,module,exports) {
"use strict";
...
var removeLocalToken = function removeLocalToken() {
  return localStorage.removeItem("token");
};

var classNames = function classNames(classArr) {
  return classArr.filter(function (el) {
    return el;
  }).join(" ");
}; // filter falsy values
...
var SignupForm = function SignupForm() {
  ...
  var _useState3 = (0, _hooks.useState)({
    ...
    errors: []
      ...
      passwordState = _useState4[0],
      setPasswordState = _useState4[1];
  ...
  var onSubmit = function onSubmit(event) {
    ...
    _api.api.logInGetToken(usernameState.value, passwordState.value).then(function (response) {
      console.log("success", response);
    }).catch(function (error) {
      // handle error
      // remove dirty from fields, meant for highlighting invalid fields until user edits
      [setUsernameState, setPasswordState].forEach(function (setState) {
      ...
      var errors = error.response.data.detail;
      var formError = null;
      ...
      if (Array.isArray(errors)) {
        errors.forEach(function (error) {
          var loc = error.loc,
              ...
              type = error.type;
          var msgTranslation = {
            "value_error.missing": true
          }[type];
          if (msgTranslation === undefined) return;
          var fieldName = loc[loc.length - 1];
          var setState = {
  ...
  var onUsernameChange = function onUsernameChange(event) {
    ...
    setUsernameState(function (prevState) {
      return _objectSpread({}, prevState, {
        value: value,
        isDirty: true
      });
  ...
  return (0, _preact.h)("div", null, (0, _preact.h)("h1", {
    ...
    onSubmit: onSubmit
  }, formState.error && (0, _preact.h)("div", {
    ...
    class: classNames(["shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker", !usernameState.isDirty && !!usernameState.errors.length && "error" || ""]),
    name: "username",
    type: "text",
    disabled: formState.isLoading,
    value: usernameState.value,
    onInput: onUsernameChange
  }), usernameState.errors.map(function (error) {
    return (0, _preact.h)("div", {
      class: "text-red-700 text-sm my-2"
    }, error);
  })), (0, _preact.h)("div", {
    class: "mb-6"
  }, (0, _preact.h)("label", {
    ...
    class: classNames(["shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker mb-3", !passwordState.isDirty && !!passwordState.errors.length && "error" || ""]),
    name: "password",
    type: "password",
    disabled: formState.isLoading,
    value: passwordState.value,
    onInput: onPasswordChange
  }), passwordState.errors.map(function (error) {
    return (0, _preact.h)("div", {
      class: "text-red-700 text-sm my-2"
    }, error);
  })), (0, _preact.h)("div", {
    ...
    type: "submit",
    disabled: formState.isLoading
  }, "Innskr\xE1")), (0, _preact.h)("div", {
    class: "mt-4 md:mt-0"
  }, (0, _preact.h)("a", {
    href: "#",
    class: "text-green no-underline"
  }, "Gleymt lykilor\xF0?"))))));
};

exports.SignupForm = SignupForm;
},{"preact":"../node_modules/preact/dist/preact.module.js","preact/hooks":"../node_modules/preact/hooks/dist/hooks.module.js","./api":"api.js"}],"modals.js":[function(require,module,exports) {
"use strict";
...
document.getElementById("login").addEventListener("click", function (event) {
  ...
  (0, _preact.render)((0, _preact.h)(_accounts.SignupForm, null), el);
});
